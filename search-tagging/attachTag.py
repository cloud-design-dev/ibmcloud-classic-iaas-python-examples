...
def main(resource_crn, tag_name):
    ...
    tag_results = service.attach_tag(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--resource_crn', required=True, help='The CRN of the resource to tag')
    parser.add_argument('-t', '--tag_name', required=True, help='The name of the tag to attach')
